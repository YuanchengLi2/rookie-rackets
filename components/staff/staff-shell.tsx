...
import { LayoutDashboard, CalendarRange, ClipboardList, UsersRound, Building2, FolderKanban, WalletCards, Settings, Menu, X, RefreshCw, ExternalLink } from 'lucide-react';
