...
values
  ('10000000-0000-4000-8000-000000000001', 'Boys Club Raleigh', 'community-center', '', 'Raleigh, NC', 'Program coordinator', null, 'active-partner', 'Fall roster confirmed', 'Confirm coaches for the next session'),
...
values
  (
    '30000000-0000-4000-8000-000000000001', 'boys-club-fall', 'Boys Club Fall',
    '10000000-0000-4000-8000-000000000001', 'recurring-partner-program',
    'An intro series for first-time players with a relaxed, coach-led format.', 'Boys Club of Raleigh',
    'beginner', 'Grades 3–8', 24, '20000000-0000-4000-8000-000000000001', 'active', 'public', 0,
    '2026-12-18', array['Athletic shoes', 'Water bottle'], true, '/images/hero-workshop.webp',
  ...
  (
    ...
    'Five school workshops that move from racket basics to cooperative games.', 'TMSA Elementary',
    'mixed', 'Elementary students', 20, '20000000-0000-4000-8000-000000000003', 'registration-open', 'public', 0,
    '2026-12-20', array['Athletic shoes'], true, '/images/gallery-certificates.webp',
    'Rookie Rackets team · teamrookierackets@gmail.com'
  ),
  (
    ...
    '2027-01-10', array['Athletic shoes'], true, '/images/story.webp',
    'Rookie Rackets team · teamrookierackets@gmail.com'
  )
on conflict (id) do update set
...
values
  ...
  (
    ...
    'Boys Club of Raleigh', '20000000-0000-4000-8000-000000000002',
    ...
    'scheduled', 'Confirm the final coach roster.'
  ),
  (
...
values
  ...
  ('50000000-0000-4000-8000-000000000003', '40000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000002', 'lead', true),
