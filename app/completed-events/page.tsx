...
const eventRecord = [
  ...
  { date: 'Sep 2026', name: 'Peak Sports Awareness Booth', description: 'Volunteers spoke with visitors at Peak Sports, shared the Rookie Rackets mission, and showed families how to learn about free, inclusive workshops.' },
];
  ...
  return <main className="completed-page"><SiteHeader active="/completed-events" />
    ...
    <section className="event-highlights shell" data-reveal>
      ...
      <div className="event-highlight-grid">
        ...
        <article><img src="/images/peak-sports-summer-camp.webp" alt="A coach and young players practicing at the Rookie Rackets camp at Peak Sports"/><span>Aug 3–6, 2026</span><h3>Rookie Rackets Camp at Peak Sports</h3><p>Eleven campers spent four days building serving, rallying, and movement skills. The hosted camp raised funds for facility fees and equipment donated to the community.</p></article>
        ...
        <article><img src="/images/peak-sports-awareness-booth.jpg" alt="A visitor talking with Rookie Rackets volunteers at the Peak Sports awareness booth"/><span>Sep 2026</span><h3>Peak Sports Awareness Booth</h3><p>Volunteers shared the Rookie Rackets mission and introduced visitors to its free, inclusive workshops.</p></article>
      </div>
    </section>

    <section className="summer-record shell" data-reveal><h2>Summer 2026</h2><p>Three hosted camps. Three partnerships. More time on court.</p><div><figure><img src="/images/vibha-summer-camp.webp" alt="Players and coaches at the VIBHA Rookie Rackets summer camp"/><figcaption><strong>VIBHA Rookie Rackets Camp</strong><span>Jul 20–24, 2026</span></figcaption></figure><figure><img src="/images/peak-sports-summer-camp.webp" alt="Young players practicing at the Rookie Rackets Peak Sports camp"/><figcaption><strong>Rookie Rackets Camp at Peak Sports</strong><span>Aug 3–6, 2026 · 11 campers · four-day fundraiser</span></figcaption></figure><figure><img src="/images/rjourney-group.webp" alt="RJourney summer camp group"/><figcaption><strong>RJourney Camp</strong><span>Aug 10–14, 2026</span></figcaption></figure></div></section>
